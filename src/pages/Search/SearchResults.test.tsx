...
describe("SearchResults", () => {
  ...
  describe("urls-only results", () => {
    ...
    it("displays truncated URL as subtitle", () => {
      render(
        <MemoryRouter>
          <SearchResults status="success" books={[]} urls={mockUrlBundles} />
        </MemoryRouter>,
  ...
  describe("URL truncation", () => {
    it("truncates long URLs with ellipsis", () => {
      const longUrlBundle: UrlChunkBundle[] = [
        {
          url: {
            id: "url-long",
            url: "https://example.com/very/long/path/that/exceeds/sixty/characters/limit/here",
      ...
      render(
        <MemoryRouter>
          <SearchResults status="success" books={[]} urls={longUrlBundle} />
        </MemoryRouter>,
      );

      expect(
        screen.getByText(
          "https://example.com/very/long/path/that/exceeds/sixty/charac...",
        ),
      ).toBeInTheDocument();
    });
  });
